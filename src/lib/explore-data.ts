...
export const explorePosts: Post[] = [
  { id: 'explore-lake', name: 'alex.rivera', avatar: media.alex, photo: require('../../assets/images/profile/photo-1.png'), title: 'Morning views at\nLake Louise 🏔️', tags: ['travel', 'nature'], likes: 124 },
  { id: 'explore-dog', name: 'maya.b', avatar: media.dogAvatar, photo: require('../../assets/images/profile/photo-2.png'), title: 'Beach days are\nalways better 💙', tags: ['pets', 'lifestyle'], likes: 86 },
  { id: 'explore-palms', name: 'taylor.b', avatar: media.taylor, photo: require('../../assets/images/profile/photo-3.png'), title: 'Golden hour in\nSan Diego 🌅', tags: ['travel', 'nature', 'lifestyle'], likes: 102 },
  { id: 'explore-city', name: 'jordan.k', avatar: media.jordan, photo: require('../../assets/images/profile/photo-4.png'), title: 'City lights, bigger\ndreams ✨', tags: ['travel', 'design'], likes: 210 },
  { id: 'explore-coast', name: 'casey.dev', avatar: media.casey, photo: require('../../assets/images/profile/photo-7.png'), title: 'Find your next\nhorizon 🌊', tags: ['travel', 'nature'], likes: 178 },
  { id: 'explore-coffee', name: 'maya.b', avatar: media.maya, photo: require('../../assets/images/profile/photo-6.png'), title: 'Good coffee,\nbrighter days ☕', tags: ['food', 'lifestyle'], likes: 95 },
